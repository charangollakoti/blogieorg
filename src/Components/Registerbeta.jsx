      ...
      <div className="main-page">
        ...
        <div className="register-box">
          ...
          <form action="" onSubmit={(e) => handleSubmit(e)}>
            ...
            {/* <ReCAPTCHA
              sitekey="6LeDvKQpAAAAAOV1E4YFO_mtTuYwV10huYr5lwPf"
              onClick={onclickCheck}
              className="recaptcha"
            /> */}

            {/* have to check this syntax  for checked thing */}
            {/* <input type="checkbox" checked={setIsCaptchaVerified(false)} className="recaptcha"/> */}
            <center>
              {!loading ? (
                <button
                  className="btn6"
